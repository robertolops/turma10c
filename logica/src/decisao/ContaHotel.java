...
public class ContaHotel {
	...
	public static void main(String[] args) {
		 ...
		 */
	Short qtde = Short.parseShort(JOptionPane.showInputDialog("Qual foi a quantidade de diárias?"));
	if (qtde < 15) {
		JOptionPane.showMessageDialog(null, "Total da estadia é de: R$ " + ((80*qtde)+(qtde*8)));
	} else if (qtde == 15) {
		JOptionPane.showMessageDialog(null, "Total da estadia é de: R$ " + ((80*qtde)+(qtde*6)));
	} else {	
		JOptionPane.showMessageDialog(null, "Total da estadia é de: R$ " + ((80*qtde)+(qtde*5.5)));
	}
	}
