...
public class DesafioDoEtapa2 {
	...
	public static void main(String[] args) {
		...
		while (numero != adivinha) {
			adivinha = Integer.parseInt(JOptionPane.showInputDialog("você errou, tente novamente"));
			tentativas = tentativas+1;
			if (adivinha == numero) {
				JOptionPane.showMessageDialog(null, "você adivinhou o numero, o número é " + adivinha + " e o numero de tentativas foi " + tentativas);
