...
public class DesafioFor2Melhorado {
	...
	public static void main(String[] args) {
		...
		/*
		 * 2º) Monte um programa que solicite a idade e o 
		 * nome das pessoas. Ao terminar, (quando o usuário 
		 * responder "SIM", que ele quer terminar) o programa deverá exibir:
		 ...
		 */
		 ...
		 System.out.println("Média da soma das idades: " + (somaidade/qtde) + "\n");
